...
# Name : Running_XP_Title
# Usage : 
# 메인 위에 삽입하시고, 
# Main스크립트에서 
# $scene = Scene_Title.new 부분을 $scene = Running_Title.new로 바꾸세요.
# 리소스 파일을 소재 관리 'Picture'로 불러오세요.
#
# 타이틀 디자인을 바꾸고 싶은 경우,
# 이미지 타이틀 스크립트이므로 동봉된 이미지만 편집해서 바꿔주시면 됩니다.
# 타이틀 부분의 문자는 640X480 PNG로 문자를 제외한 나머지는 투명으로 하고 저장하세요.
# 편집된 이미지의 크기를 크게 벗어나지 않는 선에서 작업하면 됩니다.
#================================================================================
